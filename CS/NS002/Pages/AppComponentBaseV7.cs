...
namespace CaotunSpring002
{
    ...
    public class AppComponentBaseV7 : ComponentBase
    {
        ...
        public IDbContextFactory<NS002Context> DbFactory { get; set; }
      ...
      //  string rootPath = _webHostEnvironment.WebRootPath
        ...
        public async Task<List<Object>> GetItemsAsync(string ENT, IAdapterV7 a)
        {
            ...
            {
                case nameof(Sales):
                    PageHelper.TotalItemCount = db.Sales.Where(a.GetWhere()).Count();
                    objs = await db.Sales.Where(a.GetWhere()).OrderBy(a.GetOrderBy())
