...
namespace NS4
{
    ...
    public partial class A003Sales : ComponentBase
    // public class A003SalesBase : IComponent

    {
        ...
        [Inject]
        public A003Adapter QueryAdapter { get; set; }
        ...
        private List<Sales> Items { get; set; } // 本頁面要顯示的內容     // === 要調整的地方 ===
