namespace CaotunSpring002.Adapter
{
    ...
    /// </summary>
  //  public class PageHelperA000 : IPageHelperA000
    public class PageHelperV7 : IPageHelperV7
    {
        /// <summary>
        /// Items on a page.
        /// </summary>
        ...
        public string PrevPageStr =>  Page <= 1 ? BaseUrl+ Page : BaseUrl +( Page - 1);
        ...
        public string NextPageStr => Page < PageCount ? BaseUrl + (Page + 1) : BaseUrl + Page;
